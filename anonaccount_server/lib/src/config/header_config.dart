/// Configuration for AnonAccount header names
/// Allows customization of header names used for authentication
class AnonAccountHeaderConfig {
  ...
  static const String _prefixEnvVar = 'ANONACCOUNT_HEADER_PREFIX';

...
--
-- Class AppleConsumableDelivery as table apple_consumable_delivery
--
...
--
-- Class ConsumableDelivery as table consumable_delivery
--
...
CREATE TABLE "transaction_payment" (
    ...
    "paymentRef" text,
    "transactionTimestamp" timestamp without time zone,

...
void main() {
  group('Crypto Integration Tests', () {
    test('complete challenge-response authentication flow', () async {
      ...
      final publicKeyHex = CryptoUtils.bytesToHex(Uint8List.fromList(publicKey.bytes));
    ...
    test('challenge-response fails with wrong key', () async {
      ...
      final publicKeyAHex = CryptoUtils.bytesToHex(Uint8List.fromList(publicKeyA.bytes));

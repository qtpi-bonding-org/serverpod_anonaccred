...
void main() {
  withServerpod('DeviceEndpoint Integration Tests', (sessionBuilder, endpoints) {

    test('registerDevice - should register device successfully with valid data', () async {
      // Create a test account first
      const accountPublicKey = '5123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
      ...
      const publicSubKey = '6123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
    ...
    test('registerDevice - should reject duplicate public subkey registration', () async {
      // Create a test account first
      const accountPublicKey = '7123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
      ...
      const publicSubKey = '8123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
      const encryptedDataKey = 'device_encrypted_data_key';
      const label = 'Test Device';
    ...
    test('registerDevice - should reject invalid public subkey format', () async {
      // Create a test account first
      const accountPublicKey = '9123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
    ...
    test('registerDevice - should reject registration for non-existent account', () async {
      const publicSubKey = 'a123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
      const encryptedDataKey = 'device_encrypted_data_key';
      const label = 'Test Device';
    ...
    test('generateAuthChallenge - should generate unique challenges', () async {
      final challenge1 = await endpoints.device.generateAuthChallenge(sessionBuilder);
      final challenge2 = await endpoints.device.generateAuthChallenge(sessionBuilder);
    ...
    test('listDevices - should return empty list for account with no devices', () async {
      // Create a test account first
      ...
      final devices = await endpoints.device.listDevices(sessionBuilder, testAccount.id!);
      expect(devices, isEmpty);
    });

    test('listDevices - should return all devices for account', () async {
      // Create a test account first
      const accountPublicKey = 'c123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
      ...
      expect(devices.map((d) => d.label), containsAll(['Device 1', 'Device 2']));
    });

    test('listDevices - should reject listing for non-existent account', () async {
      const nonExistentAccountId = 99999;

      expect(
        () => endpoints.device.listDevices(sessionBuilder, nonExistentAccountId),
        throwsA(isA<Exception>()),
      );
    });
    ...
    test('revokeDevice - should revoke device successfully', () async {
      // Create a test account first
      const accountPublicKey = 'f123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef';
    ...
    test('revokeDevice - should throw exception for non-existent device', () async {
      // Create a test account first
      const accountPublicKey = '0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcde1';

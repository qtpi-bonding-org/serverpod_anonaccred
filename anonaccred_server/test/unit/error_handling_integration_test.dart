...
void main() {
  withServerpod('Error Handling Integration Tests', (sessionBuilder, endpoints) {
    group('Authentication Error Handling', () {
      ...
      test('should return structured error for device not found', () async {
        final nonExistentPublicKey = '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef';
        final challenge = 'test_challenge';
        final signature = '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef';
      ...
      test('should return structured error for account not found', () async {
        ...
        try {
          await endpoints.device.listDevices(sessionBuilder, nonExistentAccountId);
          fail('Expected AuthenticationException to be thrown');
        } catch (e) {
      ...
      test('should handle duplicate device registration', () async {
        ...
        final accountPublicKey = '1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef';
        ...
        // Register device
        final devicePublicSubKey = 'abcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890';
    ...
    group('AuthenticationResult Error Analysis', () {
      ...
      test('should provide comprehensive error analysis for failure', () async {
        ...
        expect(failureResult.errorMessage, equals('Signature verification failed'));
